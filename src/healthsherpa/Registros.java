...
public class Registros {
    ...
    {
        return User.SELECCIONAR_TODO+" where id_user < "+id_user+" limit 1";
    }
    ...
    {
        return User.SELECCIONAR_TODO+" where id_user = "+id_user+" order by fecha asc limit 1";
    }
     
    public static String getUltimo(int id_user)
    {
        return User.SELECCIONAR_TODO+" where id_user = "+id_user+" order by fecha desc limit 1";
    }
    ...
    public int grabar()
    {
       //Cambio del tipo de datos util.Date a sql.Date
        ...
        String sql = "INSERT INTO registros (id_user, peso, cintura, cuello, cadera, fecha)"+
    ...
    {
        ResultSet registros = ConexionBBDD.getRegistros(User.SELECCIONAR_TODO+" WHERE id_user='"+id_user+"'");
        ...
        try{
            while(registros.next())
            {
                ...
                registro.setFecha(new java.util.Date(registros.getDate("fecha").getTime()));//fecha nacimiento
